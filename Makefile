...
# Source files
#
COMMON_SRCS=Samba.cpp Flash.cpp FlashCALW.cpp FlashAppletCode.cpp FlashApplet.cpp NvmFlash.cpp FlashFactory.cpp Applet.cpp WordCopyApplet.cpp Flasher.cpp
